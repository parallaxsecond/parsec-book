...
5. *(GNRC)* The authentication tokens are stored with confidentiality by the clients.
...
| 2  | *(not DRCT)* The authenticators should only allow authentication tokens that are secure enough that brute-force attacks are not feasible.                                                                                                                                                                  | Not applicable currently as Parsec does not implement the GNRC case.                                                                                                                |
