...
| ID | Justification                                                                                                                                                                                        | Details                                                                                                                                                                                                             | Validation                                                |
|----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
...
| 5  | Parsec is coded with safety in mind and is tested extensively.                                                                                                                                       | [Done](https://github.com/parallaxsecond/parsec-book/issues/35)                                                                                                                                                     | E2E tests                                                 |
| 6  | The `ManageKeyInfo` implementations communicate with its persistence storage backend through a mechanism respecting confidentiality, integrity and availability.                                     | Both On-Disk and SQ Key Lite Info Manager: the mappings are stored on-disk/SQ Lite database using the filesystem provided by the OS. OS file permissions are used.                                                  | Unit tests in on disk and SQ Lite key info manager module |
