...
| OS signals                                       | OS signals should still have the same behavior in future stable Parsec versions.                                                                       | Signal handlers must not be removed in Parsec.                                                                                                                                                                                                                      | [Done](https://github.com/parallaxsecond/parsec/issues/395)                                                |
